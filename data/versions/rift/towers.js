// Rift towers: the full eight-tower arsenal (same balanced stats), flavour-
// named for the rift. Every mechanic in the game available on one map.
globalThis.RiftVersion = globalThis.RiftVersion || {};
RiftVersion.towers = {
  arrow: {
    name: 'Страж разлома', role: 'Быстрый урон по одной цели', targets: ['ground', 'air'],
  ...
  cannon: {
    name: 'Камнемёт бездны', role: 'Сплэш-урон, только по земле', targets: ['ground'],
  ...
  frost: {
    name: 'Иней трещин', role: 'Замедляет врагов', targets: ['ground', 'air'],
  ...
  antiair: {
    name: 'Копьё небес', role: 'Только воздух, высокий урон', targets: ['air'],
  ...
  storm: {
    name: 'Разрядник', role: 'Цепная молния: перескакивает между целями', targets: ['ground', 'air'],
  ...
  poison: {
    name: 'Кислотный шип', role: 'Яд: урон со временем, игнорирует броню', targets: ['ground', 'air'],
  ...
  sniper: {
    name: 'Дальний дозор', role: 'Очень большая дальность', targets: ['ground', 'air'],
  ...
  multishot: {
    name: 'Картечница', role: 'Залп по нескольким целям', targets: ['ground', 'air'],
