// Wastes towers: the full arsenal — all seven Classic towers PLUS the Storm
// tower (chain lightning) from Canyon. Eight tower types, the richest roster in
// the game, to match the hardest map. Stats mirror the other versions (balanced
// values), only the flavour names differ.
globalThis.WastesVersion = globalThis.WastesVersion || {};
WastesVersion.towers = {
  arrow: {
    name: 'Дозорная башня', role: 'Быстрый урон по одной цели', targets: ['ground', 'air'],
  ...
  cannon: {
    name: 'Требушет', role: 'Сплэш-урон, только по земле', targets: ['ground'],
  ...
  frost: {
    name: 'Морозный шпиль', role: 'Замедляет врагов', targets: ['ground', 'air'],
  ...
  antiair: {
    name: 'Зенитный расчёт', role: 'Только воздух, высокий урон', targets: ['air'],
  ...
  storm: {
    name: 'Грозовая башня', role: 'Цепная молния: перескакивает между целями', targets: ['ground', 'air'],
  ...
  poison: {
    name: 'Чумной шип', role: 'Яд: урон со временем, игнорирует броню', targets: ['ground', 'air'],
  ...
  sniper: {
    name: 'Дальнобойня', role: 'Очень большая дальность', targets: ['ground', 'air'],
  ...
  multishot: {
    name: 'Веерострел', role: 'Залп по нескольким целям', targets: ['ground', 'air'],
